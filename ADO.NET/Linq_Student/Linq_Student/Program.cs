...
new List<int> {35, 72, 91, 70}},
        ...
        {
            Console.WriteLine("Упражнение 1 - Создание и выполнение простого запроса");
 ...
 select student).ToList();
            ...
            foreach (Student student in studentList)
            {
                ...
                Console.WriteLine("Упражнение 2 - Добавление дополнительного условия фильтра");
                var studentQuery2 =
 ...
 group student1 by student1.Last[0];
                foreach (var studentGroup in studentQuery2)
                {
                    ...
                    {
                        Console.WriteLine(" {0}, {1}", student1.Last, student1.First);
                    }
                }
                Console.WriteLine("Упражнение 3 - Расширение возможностей запроса");
 ...
 group student2 by student2.Last[0];
                foreach (var groupOfStudents in studentQuery3)
                {
                    ...
                    {
                        Console.WriteLine(" {0}, {1}", student2.Last, student2.First);
                    }
                }
                Console.WriteLine("Упорядочение групп по значению их ключа");
                var studentQuery4 =
 ...
 select studentGroup;
                foreach (var groupOfStudents in studentQuery4)
                {
                    ...
                    {
                        Console.WriteLine(" {0}, {1}", student3.Last, student3.First);
                    }
                }
                Console.WriteLine("Введение идентификаторов с помощью let");
                var studentQuery5 =
 ...
 select totalScore;
                ...
                Console.WriteLine("Использование синтаксиса метода в выражении запроса");
